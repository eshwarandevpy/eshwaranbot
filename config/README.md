...
### Get to know about all these vars in depth from our Docs. [Read Now from Here](https://eshwarandevpy.gitbook.io/eshwaranbot/config-vars/available-vars)

## Mandatory Vars

- These are the minimum required vars need to setup to make eshwaranbot functional.

1. `API_ID` : Get it from my.telegram.org 
2. `API_HASH`  : Get it from my.telegram.org 
3. `BOT_TOKEN` : Get it from [@Botfather](http://t.me/BotFather) in Telegram
4. `MONGO_DB_URI` : Get mongo db [from here.](https://eshwarandevpy.gitbook.io/eshwaranbot/deployment/mongodb)
...
### How to get these? [Read from here](https://eshwarandevpy.gitbook.io/eshwaranbot/deployment/spotify)
...
### How to get these? [Read from here](https://eshwarandevpy.gitbook.io/eshwaranbot/config-vars/heroku-vars)
...
- If you plan to use eshwaranbot with your own customized or modified code.
...
- You can change images which are used in eshwaranbot.
