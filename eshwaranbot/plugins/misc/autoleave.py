...
from eshwaranbot.core.call import eshwaranbot, autoend
from eshwaranbot.utils.database import (get_client, is_active_chat,
                                       is_autoend)
                    ...
                    async for i in client.iter_dialogs():
                        ...
                        if chat_type in [
                            ...
                            if (
                                ...
                                and chat_id != -1002312179274
                                and chat_id != -1002477339734
                                and chat_id != -1002350548336
                            ):
                                if left == 20:
                                    continue
