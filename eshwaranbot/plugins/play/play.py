...
from eshwaranbot import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from eshwaranbot.core.call import eshwaranbot
from eshwaranbot.utils import seconds_to_min, time_to_seconds
from eshwaranbot.utils.channelplay import get_channeplayCB
from eshwaranbot.utils.database import is_video_allowed
from eshwaranbot.utils.decorators.language import languageCB
from eshwaranbot.utils.decorators.play import PlayWrapper
from eshwaranbot.utils.formatters import formats
from eshwaranbot.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from eshwaranbot.utils.inline.playlist import botplaylist_markup
from eshwaranbot.utils.logger import play_logs
from eshwaranbot.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await eshwaranbot.stream_call(url)
...
@app.on_callback_query(
    filters.regex("eshwaranbotPlaylists") & ~BANNED_USERS
)
@languageCB
