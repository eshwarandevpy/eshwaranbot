...
from eshwaranbot.utils.database import add_sudo, remove_sudo
...
async def useradd(client, message: Message, _):
    if MONGO_DB_URI is None:
        return await message.reply_text(
            "**Due to bot's privacy issues, You can't manage sudo users when you're using eshwaranbot's Database.\n\n Please fill your MONGO_DB_URI in your vars to use this feature**"
        )
