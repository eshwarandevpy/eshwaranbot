...
from eshwaranbot.utils.database import get_authuser_names, get_cmode
from eshwaranbot.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from eshwaranbot.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await eshwaranbot.stop_stream(message.chat.id)
    except:
        pass
