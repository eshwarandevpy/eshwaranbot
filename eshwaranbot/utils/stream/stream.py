...
import config
from eshwaranbot import Carbon, YouTube, app
from eshwaranbot.core.call import Dusky
from eshwaranbot.misc import db
from eshwaranbot.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from eshwaranbot.utils.exceptions import AssistantErr
from eshwaranbot.utils.inline.play import (stream_markup,
                                          telegram_markup)
from eshwaranbot.utils.inline.playlist import close_markup
from eshwaranbot.utils.pastebin import eshwaranbotbin
from eshwaranbot.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await eshwaranbot.force_stop_stream(chat_id)
